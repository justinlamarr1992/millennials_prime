      ...
      <div id="player">
        ...
        <div id="player-controls">
          <div className="control">
            <div className="music-button" id="play-previous">
          ...
          <div className="control">
            <div className="music-button" id="play-pause-button">
          ...
          <div className="control">
            <div className="music-button" id="play-next">
